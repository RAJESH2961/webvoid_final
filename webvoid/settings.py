"""
Django settings for webvoid project.
...
SECRET_KEY = 'django-insecure--@(^-w(!l(v+mwr2@zng4%^9aje8-j)fn(8zk5l7y!%k#78j_$'
...
WSGI_APPLICATION = 'webvoid.wsgi.application'
